public class Robot extends IterativeRobot {
	...
	SpeedController BackRightDrive = new Spark(7);
	...
	public void teleopPeriodic() {
	   ...
	   /* 
		...
		if (OpStick.getRawButton(6)) {
			...
			DoorShooter.setAngle(180);
		}
		
		// Gear Door Servos
		if (OpStick.getRawButton(1)) {
			DoorLeft.setAngle(150);
			DoorRight.setAngle(100);
		} else {
			DoorLeft.setAngle(100);
			DoorRight.setAngle(140);
		}*/
	...
	public void SwerveDrive(double dspeed, double steer, double diffspeed, boolean mode) {
		...
		if (mode) {
			...
			FrontLeftEq = jsgain_front*(stick.getRawAxis(4)) + 4.3;
			FrontRightEq = jsgain_front*(stick.getRawAxis(4)) + 4.3;
			BackLeftEq = jsgain_back*(stick.getRawAxis(4)) + 0.8;
			BackRightEq = jsgain_back*(stick.getRawAxis(4)) + 1.94;
			...
			SmartDashboard.putNumber("Fr", FrontRightAverage);
			SmartDashboard.putNumber("Fl", FrontLeftAverage);
			SmartDashboard.putNumber("Br", BackRightAverage);
			SmartDashboard.putNumber("Bl", BackLeftAverage);
